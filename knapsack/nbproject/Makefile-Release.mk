...
${OBJECTDIR}/Knapsack.o: nbproject/Makefile-${CND_CONF}.mk Knapsack.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../CoinMP/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Knapsack.o Knapsack.cpp

${OBJECTDIR}/main.o: nbproject/Makefile-${CND_CONF}.mk main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../CoinMP/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
